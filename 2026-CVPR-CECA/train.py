...
if __name__ == '__main__':
    ...
    if '+pre' in args.loss_names:
        ...
        model_pre = f'/home/zh_2023/CMTS-main/{pre_dict[args.dataset_name]}.pth'
        ...
        for k in list(param_dict.keys()):
            ...
            if 'base_model.positional_embedding' in k and args.text_length!=77:
                logger.info(f"target {args.text_length}.")
                None
            else:
