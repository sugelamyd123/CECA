...
def do_train(start_epoch, args, model, train_loader, evaluator, optimizer,
    ...
    meters = {
        ...
        "merge_loss":AverageMeter(),
        #"tse_merge":AverageMeter(),
    ...
    for epoch in range(start_epoch, num_epoch + 1):
        ...
        for n_iter, batch in enumerate(train_loader):
            ...
            meters['merge_loss'].update(ret.get('merge_loss', 0), batch_size)
            #meters['tse_merge'].update(ret.get('tse_merge', 0), batch_size)
