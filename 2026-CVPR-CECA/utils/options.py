...
def get_args():
    ...
    parser.add_argument("--noisy_file", default='./noiseindex/CUHK-PEDES_0.0.npy', type=str)
    ...
    parser.add_argument("--root_dir", default="/data/zh_2023/text-image_retrival")
    ...
    "--dataset_roots_json",
    default=json.dumps({
        "CUHK-PEDES": "/data01/zh_2023/text-image_retrival/CUHK-PEDES",
        "ICFG-PEDES": "/data01/zh_2023/text-image_retrival/ICFG-PEDES",
        "RSTPReid":   "/data01/zh_2023/text-image_retrival/RSTPReid",
    })
)
    ...
    parser.add_argument(
        "--chat_json_map",
        default=json.dumps({
            "CUHK-PEDES": "/data01/zh_2023/text-image_retrival/CUHK-PEDES/caption_chat.json",
            "ICFG-PEDES": "/data01/zh_2023/text-image_retrival/ICFG-PEDES/chat_ICFG-PEDES.json",
            "RSTPReid":   "/data01/zh_2023/text-image_retrival/RSTPReid/chat_captions.json",
        })
    )

  
    parser.add_argument("--chat_dirs", default="chats,captions,chat")   #
    parser.add_argument("--chat_exts", default=".txt,.json")            #


    parser.add_argument("--require_chat", action="store_true", default=False)


    parser.add_argument("--chat_length", type=int, default=77)
